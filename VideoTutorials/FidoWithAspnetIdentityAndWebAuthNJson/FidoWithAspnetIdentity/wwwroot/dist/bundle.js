...
var webauthn_json_1 = __webpack_require__(/*! @github/webauthn-json */ "./node_modules/@github/webauthn-json/dist/index.esm.js");
var jquery_1 = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function login(base64Challenge, relyingPartyId, base64KeyIds, completeLoginCallback) {
    return __awaiter(this, void 0, void 0, function () {
        var keys, allowCredentials, result, encodedResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    keys = JSON.parse(base64KeyIds);
...
exports.login = login;
function register(base64Challenge, relyingPartyId, base64UserHandle, userId, completeRegistrationCallback) {
    return __awaiter(this, void 0, void 0, function () {
        var pubKeyCredParams, rp, user, credentials, encodedCredentials;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pubKeyCredParams = [
                    ...
                    return [4, webauthn_json_1.create({
                            publicKey: {
                                challenge: base64Challenge,
                                rp: rp,
                                user: user,
